...
RSpec.describe 'GET /food', type: :request do
  ...
  before do
    ...
    food.insert(name: 'Coronation Chicken sandwich',
                description: 'Cooked chicken in a creamy curried dressing makes a sandwich fit for a Queen!')
    food.insert(name: 'Sausage Rolls',
                description: 'Savoury pastry meal, popular in current and former Commonwealth nations, consisting of sausage meat wrapped in puff pastry.')
  end
